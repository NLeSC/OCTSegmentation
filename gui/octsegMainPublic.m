...
% Open the current data in the octsegVisuPublic visualization GUI
function hMenFileVisuCallback(hObject, eventdata)
    if guiMode ~= 0
        octsegVisuPublic(ActDataDescriptors, guiMode);
    end
end
...
function hMenExCSVCallback(hObject, eventdata)
    if guiMode == 2 || guiMode == 3
        csvSaveBScansPublic(ActDataDescriptors);
    elseif guiMode == 1 || guiMode == 4
